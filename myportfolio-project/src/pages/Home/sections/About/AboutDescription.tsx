      ...
      <AboutSection id="" tabIndex={-1} aria-labelledby="about-title">
        <Grid size={{ xs: 12, md: 7 }}>
          ...
          >
            ...
            Desenvolvimento, Suporte Técnico, Assistência em T.I., Atendimento e
            Liderança. Essa bagagem me deu visão ampla, foco em resultados e
            jogo de cintura pra resolver qualquer pepino.
            <br />
            <br />
            Atualmente finalizando minha graduação em Análise e Desenvolvimento
            de Sistemas (ADS), com foco em Front-End e Full-Stack. Tenho
            ...
            linguagens como Java, C, C++ e C#, porque conhecer várias linguagens
            é sempre poder de fogo extra.
            <br />
            <br />
            ...
            <br />
            <br />
            Meu objetivo? Seguir evoluindo como desenvolvedor, criando soluções
            que impactem pessoas e negócios de verdade.
          </Typography>
        </Grid>
      </AboutSection>
      {/* </Element> */}
